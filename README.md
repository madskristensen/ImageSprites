...
That will produce a file called something like *mysprite.css*
...
```html
<link href="mysprite.css" rel="stylesheet" />
```
...
.myclass {
  ...
  height: 16px;
  display: block;
  background: url('mysprite.png') -36px -10px no-repeat;
}
```
